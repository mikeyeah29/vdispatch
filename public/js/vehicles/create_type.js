...
!function(Form, ImageLibrary){
	...
	var vehicleTypeForm = new Form('/vehicles/types/create-type', [
		{
			id: 'q_name',
			validation: ''
		},
	...
	submit_btn.on('click', function(){
		...
		if(vehicleTypeForm.isValid()){
			...
			vehicleTypeForm.send(data, function(data){
				...
				if(!data.error){
					var msg = new Message(
								'Vehicle Type Created. <a href="/vehicles">View Vehicles & Types</a> or <a href="/vehicles/type/edit/' + data.vehicletype._id + '">Edit this vehicle type</a>', 
								false, 
								$('#message_box')
							);
					msg.display(true);
